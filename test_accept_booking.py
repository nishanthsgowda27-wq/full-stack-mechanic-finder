...
# Ensure users/services exist (demo data should be present)
...
# Use test client to POST accept as mechanic
client = Client()
client.force_login(mech_user)
resp = client.post(f'/booking/{booking.pk}/accept/', {}, HTTP_HOST='127.0.0.1:8000')
print('POST response status:', resp.status_code)

# Refresh booking
booking.refresh_from_db()
print('After accept: status=', booking.status)
